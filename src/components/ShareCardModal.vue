    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">宝妈成长与生活平衡</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 宝妈成长与生活平衡助手</span>
...
// 清理回复末尾的特殊标记 [BAOMA_SCORES]...[/BAOMA_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[BAOMA_SCORES\][\s\S]*?\[\/BAOMA_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 宝妈成长与生活平衡专家】\n\n${cleanContent.value}\n\n体验宝妈成长AI助手：https://ai.wuxian.xyz`;
